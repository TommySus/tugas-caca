            ...
            <div id="register-box" class="col-4 mx-auto">
                ...
                <form class="d-flex flex-column" @submit.prevent="register">
                    <div id="form-register">
                        ...
                        <input v-model="name" type="text" id="form-input-name" placeholder="name" required>
                    ...
                    <div id="form-register">
                        ...
                        <input v-model="email" type="text" id="form-input-email" placeholder="email" required>
                    ...
                    <div id="form-register">
                        ...
                        <input v-model="password" type="password" id="form-input-password" placeholder="password" required>
                        <img src="https://i.dlpng.com/static/png/6599969_preview.png" id="input_img">
                    </div>
                    <div id="form-register">
                        <label for="divisi" id="form-label-divisi">divisi</label>
                        <select v-model="divisi" name="divisi" id="form-input-divisi" required>
                          <option selected value="HRD">HRD</option>
...
<style>
  ...
  #form-label-password, #form-label-email, #form-label-name, #form-label-divisi {
    position: absolute;
    top: 0;
    display: block;
    transition: 0.2s;
  ...
  #form-input-email, #form-input-password, #form-input-name, #form-input-divisi {
    margin-top: 10px;
    font-family: inherit;
    width: 110%;
    border: 0;
